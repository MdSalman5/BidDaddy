  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
      ...
      <div className="fixed top-4 right-4 z-50">
        <div className="flex space-x-1 p-1 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
          ...
          {authService.isDemoMode() && (
            <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
              <p className="text-sm text-yellow-800 dark:text-yellow-200 text-center">
                <strong>Demo Mode:</strong> Registration creates a demo account
              </p>
            </div>
          )}
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 py-16 text-white">
          <div className="max-w-md">
            ...
            <p className="text-xl text-purple-100 mb-8">
              Join our community of collectors and auction enthusiasts
            </p>
            ...
            <div className="mt-12 p-6 bg-white/10 rounded-xl">
              ...
              <p className="text-purple-100 italic">
                "BidDaddy transformed how I discover unique pieces. Secure and
                user-friendly!"
              </p>
